...
/** 
 * @author Uday Reddy
 * @version 2016-01-21 based on version of 2012, Alexandros 2015
 * 
...
public class Tree {
    ...
    public Tree() {
        this.empty = true; 
				this.value = 0; this.left = null; this.right = null;
				this.height = 0;
    }
    ...
    public static String format(Tree tree) {
        ...
        return formatTreeHelper(tree, buffer, new LinkedList<Iterator<Tree>>()).toString();
    }
